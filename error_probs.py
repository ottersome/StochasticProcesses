...
if __name__ == '__main__':
    ...
    # Do we generate a path ?
    # No I dont think so, we just want to look at the 
    # calculated probabilities in number here. 
    # So we want to calculate probability of error for every delta
    ...
    for srIdx, cur_samp_rate in enumerate(samp_rates):
        ...
        # Calculate Probabilities with Exponent(Should be Enough)
