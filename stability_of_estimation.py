...
# Idea, try different sampling rates and see how the estimation 
# of the probabilty matrix varies
...
if __name__ == '__main__':
    ...
    def_rates = args.samprate
    slow_rate = args.samprate * 2**2
    ...
    for i in range():
        ...
        all_tapes.append((roe, holdTimes_tape))
